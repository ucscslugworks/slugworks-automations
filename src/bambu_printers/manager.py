    ...
    try:
        ...
        while True:
            try:
                ...
                logger.info(f"manager: {len(rows)} forms found")
                ...
                logger.info("manager: Checking unmatched form responses for expiry")
                ...
                for u_print in db.get_unmatched_prints():
                    ...
                    if timestamp > u_print[4] + constants.BAMBU_TIMEOUT:
                        ...
                        if not matched:
                            ...
                            logger.debug(
                                f"manager: Expiring print {u_print[0]} - old print, no form found"
                            )
                ...
                for form_row in old_form_rows:
                    ...
                    if (
                        ...
                        and old_form_rows[form_row][2] + constants.BAMBU_TIMEOUT
                        < timestamp
                    ):
                    ...
                    if name in current_prints:
                        ...
                        if print_details[6] <= timestamp - 90:
                            ...
                            if printer.get_status() == constants.GCODE_FINISH:
                                ...
                                logger.debug(
                                    f"manager: Print {print_details[0]} succeeded"
                                )
                                db.archive_print(
                                ...
                                # add the print weight back to the user's limit
                                db.subtract_limit(
                                    print_details[2], -1 * print_details[8]
                                )
